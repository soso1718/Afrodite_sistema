    ...
    @if($toast)
        <div class="sticky top-0 z-50">
            <div x-data="{ show: true }"
                 ...
                 class="bg-green-600 text-white text-sm px-4 py-2 rounded-lg shadow-md text-center">
                {{ $toast }}
            </div>
        </div>
    @endif
        ...
        @if($toast)
            <div x-data="{ show: true }"
                 ...
                 class="absolute top-8 left-3 right-3 z-50
                        bg-green-600 text-white text-sm px-4 py-2 rounded-lg shadow-md text-center">
                {{ $toast }}
            </div>
        @endif
